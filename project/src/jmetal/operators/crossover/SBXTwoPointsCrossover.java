 ...
 */
public class SBXTwoPointsCrossover extends Crossover {
	 ...
	 * Constructor
	 */
	public SBXTwoPointsCrossover(HashMap<String, Object> parameters) {
		super (parameters) ;
	...
	public Solution[] doCrossover(Double realProbability,
		...
		if (PseudoRandom.randDouble()<=binaryProbability) {
			...
			//2. Calcule the points to make the crossover
			int crossoverPoint1 = PseudoRandom.randInt(0, totalNumberOfBits - 1);
                        int crossoverPoint2 = PseudoRandom.randInt(0, totalNumberOfBits - 1);
