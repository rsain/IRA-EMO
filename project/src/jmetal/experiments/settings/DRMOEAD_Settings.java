...
import jmetal.util.AspirationAndReservationLevels;
import jmetal.util.JMException;

/**
 * Settings class of algorithm MOEA/D
 */
public class DRMOEAD_Settings extends Settings {
  public double CR_ ;
  public double F_  ;
  public AspirationAndReservationLevels aspirationAndReservationLevels_;  
  public int numberOfPointsForEachObjective_;  
   ...
   * Constructor
   */
  public DRMOEAD_Settings(String problem) {
    super(problem);
    ...
    moeadVersion = "DRMOEAD" ; // or "pMOEAD"
  } // MOEAD_Settings
  ...
  public Algorithm configure() throws JMException {
    ...
    if (moeadVersion.compareTo("DRMOEAD") == 0 ) {
        algorithm = new DRMOEAD(problem_);
        algorithm.setInputParameter("aspirationAndReservationLevels", aspirationAndReservationLevels_);
        algorithm.setInputParameter("numberOfPointsForEachObjective", numberOfPointsForEachObjective_);        
        algorithm.setInputParameter("folderForOutputFiles", folderForOutputFiles_);
    }      
    else if (moeadVersion.compareTo("MOEAD") == 0 )
