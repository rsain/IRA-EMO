...
public abstract class Problem implements Serializable {
  ...
  /**
   * Stores the way each objective must be optimized (needed to transform all the
   * problems to their minimization form). This parameter need to be adjusted just 
   * in case an objective must be maximized as follows:
   * 1 if the objective should be minimized
   * -1 if the objective should be maximized
   */
  protected int    [] objective_opt_ ;
   ...
   * @return the number of decision variables.
   */
  public void setObjectiveOpt(int[] obj_opt) {
    objective_opt_ = obj_opt;   
  } // getNumberOfVariables
  /** 
   * Gets the number of decision variables of the problem.
   * @return the number of decision variables.
